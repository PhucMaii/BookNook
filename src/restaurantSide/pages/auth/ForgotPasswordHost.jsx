        ...
        <Grid container justifyContent='center'>
          <Grid item xs={14} md={6}>
            <IconButton
              ...
              color="black"
              aria-label="back"
              style={{ position: 'absolute', top: 10, left: 10, borderRadius: '10px' }} 
            >
            ...
            <Box display='flex' flexDirection='column' alignItems='center' my={1} mt={-10}>
              <LogoImg
                src='/restaurantLogo.png'
                alt='Restaurant Logo' 
              />
              <Box display='flex' flexDirection='column' alignItems='left' mt={10}>
              <Typography variant='h4' fontWeight='bold' mb={0}>
                Password Reset
              </Typography>
              <Typography variant='h10' fontWeight='light' color={grey[500]} >
